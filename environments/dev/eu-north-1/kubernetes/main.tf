...
module "eks" {
  ...
  kubernetes_version = var.cluster_version  # Use variable instead of hardcoded version
  create             = true
  ...
  eks_managed_node_groups = {
    default = {
      ...
      # Use t3.small instead of t3.micro for better availability
      instance_types = var.instance_types
      ami_type       = var.ami_type
      disk_size      = 20
      capacity_type  = "ON_DEMAND"

      # Ensure proper IAM instance profile
